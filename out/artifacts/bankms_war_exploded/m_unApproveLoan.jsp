                    ...
                    <div class="col-lg-12 text-center">
                        <div class="card">
                            <div class="card-header">
                                <h6 class="text-uppercase mb-0">未审批贷款</h6>
                            </div>
                            <div class="card-body">
                                <table class="table table-striped table-sm card-text">
                                    ...
                                    <%
                                        ...
                                        if(loans == null){
                                            response.sendRedirect("m_showUnApproveServlet");
                                        }else {
                                            for (Object o : loans) {
                                                ...
                                                out.println("<td><a href=\"http://127.0.0.1:8080/bankms/p_operateLoanServlet?operate=approve&loanID=" + ln.getLoanID() + "\" class=\"btn btn-sm btn-success\">批准</a>" +
                                                        "<a href=\"http://127.0.0.1:8080/bankms/p_operateLoanServlet?operate=refuse&loanID=" + ln.getLoanID() + "\" class=\"btn btn-sm btn-danger\">拒绝</a></td>");
                                                out.println("</tr>");
                                            }
                                        }
                                    %>
